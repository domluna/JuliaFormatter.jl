for f in [
          :n_call!, :n_curly!, :n_ref!, :n_macrocall!, :n_typedcomprehension!,
          :n_typedvcat!, :n_tuple!, :n_braces!, :n_parameters!,
          :n_invisbrackets!, :n_comprehension!, :n_vcat!, :n_bracescat!,
          :n_generator!, :n_filter!, :n_flatten!, :n_using!,
          :n_export!, :n_import!, :n_chainopcall!, :n_comparison!, :n_for!,
          #:n_vect!
         ]
