...
run_pretty(
text::String, max_margin::Int) = run_pretty(text, opts=Options(max_margin=max_margin))
...
run_nest(
text::String, max_margin::Int) = run_nest(text, opts=Options(max_margin=max_margin))
