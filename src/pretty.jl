...
Base.length(x::Whitespace) = x.n

struct PlaceholderWS <: AbstractPLeaf
    n::Int
end
Base.length(x::PlaceholderWS) = x.n
...
const ws1 = Whitespace(1)
const phws1 = PlaceholderWS(1)
...
is_placeholder(x) = x === placeholder || x isa PlaceholderWS
